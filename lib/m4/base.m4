...
m4_define([delist],[m4_esyscmd(echo $1 | PERL -nle 's/^\s*\(//g;s/\)\s*$//g;print')])m4_dnl
...
m4_define([fatal_error], [m4_errprint([m4: ] in file m4___file__ at line m4___line__ [: fatal error: $*
])m4_m4exit(1)])
